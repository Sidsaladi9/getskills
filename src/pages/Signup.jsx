    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-surface-500">Start discovering and saving AI skills</p>
        </div>

        <div className="bg-white rounded-2xl border border-surface-200 p-8">
          <button className="w-full py-3 rounded-xl border border-surface-200 text-surface-700 font-medium hover:bg-surface-50 transition-colors flex items-center justify-center gap-3 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 gradient-bg text-white font-semibold rounded-xl hover:opacity-90 transition-opacity"
            >
              Create account
            </button>
        ...
        <p className="text-center text-sm text-surface-500 mt-6">
          ...
          <Link to="/login" className="text-primary-600 font-medium no-underline hover:text-primary-700">Log in</Link>
        </p>
      </div>
    </div>
  )
