    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-[#FAFAF8]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-heading font-bold text-surface-900 mb-2">Welcome back</h1>
        ...
        <div className="bg-white rounded-2xl border border-surface-200 shadow-sm p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-sm text-surface-400">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-sm text-[#FF6B6B] font-medium no-underline hover:text-[#E85555]">
                Forgot password?
              </Link>
            </div>
          </form>
        ...
        <p className="text-center text-sm text-surface-500 mt-6">
          ...
          <Link to="/signup" className="text-[#FF6B6B] font-medium no-underline hover:text-[#E85555]">
            Sign up
          </Link>
        </p>
      </div>
